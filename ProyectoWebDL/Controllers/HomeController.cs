...
namespace ProyectoWebDL.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, ILibroServices libroServices, ApplicationDbContext context)
        {
        ...
        {
            var response = await _libroServices.GetLibros();
